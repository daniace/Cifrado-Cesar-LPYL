                ...
                <div className="flex flex-row gap-4">
                    <Card className="w-1/2">
                        ...
                        <CardContent>
                            ...
                            >
                                ...
                                {/* Desplazamiento */}
                                <div className="p-2">
                                    <Label htmlFor="desplazamiento">
                                        Desplazamiento (clave de cifrado)
                                    </Label>
                                    <Input
                                        id="desplazamiento"
                                        name="desplazamiento"
                    ...
                    <Card className="w-1/2">
                        <CardHeader className="flex flex-row items-center text-center">
                            <Lock className="h-10 w-10 rounded-2xl bg-accent p-2" />

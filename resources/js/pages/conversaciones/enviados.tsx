...
import { Circle, PenSquare } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Link } from '@inertiajs/react';
import { enviados, show, create } from '@/routes/conversaciones';
...
export default function Enviados({ conversaciones }: Props) {
    ...
    const handleConversacionClick = (conversacion: ConversacionModelo) => {
        ...
        router.visit(show(conversacion.id).url);
    };

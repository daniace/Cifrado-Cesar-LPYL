...
CREATE UNIQUE INDEX "users_nombre_usuario_unique" on "users" ("nombre_usuario");

-- Tabla de Conversaciones
CREATE TABLE "conversaciones" (
    "id" integer primary key autoincrement not null,
    "asunto" varchar not null,
    "desplazamiento_asunto" integer not null,
...
CREATE TABLE "mensajes" (
    ...
    "desplazamiento_contenido" integer not null,
